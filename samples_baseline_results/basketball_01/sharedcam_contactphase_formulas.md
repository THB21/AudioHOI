...
Code:
- historical script `scripts/shared/sharedcam/run_basketball_pose6d_sharedcam.py` has been removed from the active tree
- historical script `scripts/shared/sharedcam/support_geometry.py` has been removed from the active tree
