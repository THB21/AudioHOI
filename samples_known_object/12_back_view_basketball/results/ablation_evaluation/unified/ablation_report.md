...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| back_view_basketball | full | ok | full_audio_vlm | True | qwen | none |  | True | True | 0.035 | 0.644 | generated_eval_proxy_render_mask_iou | partial:missing_optimizer_decisions|missing_physical_smooth_residuals|missing_object_pose_pre_smooth | stage_audit_fallback | 14 | 5 | 0 |  | False |
| back_view_basketball | no_vlm | ok | no_vlm | True | none | none | disable_vlm_semantic_evidence | False | False | 0.246 | 0.648 | generated_eval_proxy_render_mask_iou | disabled_by_ablation | disabled_by_ablation | 0 | 0 | 0 |  | True |
| back_view_basketball | no_audio | ok | no_audio | False | qwen | none | disable_audio_events | False | False | 0.013 | 0.644 | generated_eval_proxy_render_mask_iou | partial:missing_optimizer_decisions|missing_physical_smooth_residuals|missing_object_pose_pre_smooth | stage_audit_fallback | 17 | 5 | 0 |  | False |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| back_view_basketball | no_vlm | True | True | True | measurable_downstream_effect | 0.211 | 0.005 |  |  | -14 | -5 | 0 |  | 36 |
| back_view_basketball | no_audio | True | True | True | measurable_downstream_effect | -0.022 | -0 |  |  | 3 | 0 | 0 |  | -3 |
