...
def main() -> None:
    ...
    visual_rows, frames, ys_smooth = detect_visual_events(
        results_dir / "ball_trajectory.csv", args.fps, args.min_gap_s
    )
