...
def build(profile: CaseProfile) -> dict[str, object]:
    """Build stable two-palm anchors for a hand-held line object.

    This is the generic composition of the existing mug stable-grasp pattern
    (persistent object-local hand anchors) and the chair line/segment pattern
    (object represented by semantic line coordinates).
    """
