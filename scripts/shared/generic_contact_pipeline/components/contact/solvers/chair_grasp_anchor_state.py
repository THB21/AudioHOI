...
and the object target is snapped back onto the observed top rail so contact
can't pull the chair away from the 2D video evidence.
"""
...
from scripts.shared.generic_contact_pipeline.components.contact.utils.contact_part_utils import build_contact_part_centers  # noqa: E402
