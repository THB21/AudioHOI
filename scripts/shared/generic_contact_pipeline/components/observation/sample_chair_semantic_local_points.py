...
This is the chair-side equivalent of mug-local contact / mesh coordinates.
It does not fit image pose. It only defines stable local 3D points and
segments that later 2D/6D fitting can project onto the video observations.
"""
