...
Doesn't anchor on the whole-chair silhouette. The mask only seeds semantic part
hypotheses; CoTracker points supply the stable samples for later propagation /
robust fitting.
"""
