...
def front_frame_parallelogram_res(
    ...
    Stage1 snaps front-leg endpoints to nearby CoTracker tracks. Here those four
    tracked endpoints are treated as one coherent front-frame quadrilateral:
    top edge, bottom edge, and the two side directions should move together.
    This is intentionally a pair-level residual, not another independent line
    detector residual.
    """
