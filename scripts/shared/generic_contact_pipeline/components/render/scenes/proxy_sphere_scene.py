#!/usr/bin/env python3
"""Generic contact pipeline proxy-sphere renderer.

This renderer treats the ball proxy and GVHMR human output as living in the same
full-image camera coordinate system with the same K_fullimg intrinsics.
