...
REGISTRY = CapabilityRegistry(
    [
        ...
        PluginSpec("observation", "rigid_mask_track", f"{OBSERVATION_MODULE}.rigid_mask_track", "build", (), ("observation.point_reference", "observation.rigid_parts"), role="mainline_implementation"),
        ...
        PluginSpec("contact", "persistent_feature_grasp", f"{CONTACT_MODULE}.persistent_feature_grasp", "build", ("observation.rigid_parts",), ("contact.candidates", "anchor.local_xyz"), role="mainline_implementation"),
        ...
        PluginSpec("pose", "rigid_mask_seed", f"{POSE_MODULE}.rigid_mask_seed", "build", ("observation.rigid_parts", "contact.candidates"), ("pose.se3",), role="mainline_implementation"),
