...
def sequence_problem_summary(case_name: str, result_dir: Path) -> dict[str, object]:
    ...
    return {
        ...
        "residual_execution_plan_records": problem["residual_execution_plan"]["record_count"],
        "residual_execution_plan_ready": problem["residual_execution_plan"]["ready_count"],
        "residual_execution_plan_blocked": problem["residual_execution_plan"]["blocked_count"],
        "residual_execution_plan_sha256": problem["residual_execution_plan"]["canonical_sha256"],
