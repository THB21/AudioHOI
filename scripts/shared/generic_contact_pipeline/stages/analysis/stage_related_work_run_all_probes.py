...
from scripts.shared.generic_contact_pipeline.core.base.config import available_cases  # noqa: E402
...
STAGE_DIR = REPO / "scripts" / "shared" / "generic_contact_pipeline" / "stages" / "analysis"
