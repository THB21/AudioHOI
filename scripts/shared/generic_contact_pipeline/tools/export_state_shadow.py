#!/usr/bin/env python3
"""Export an opt-in StateSpec/GeometryProvider shadow manifest without changing Stage 3/4."""
...
from scripts.shared.generic_contact_pipeline.core.state import build_state_shadow  # noqa: E402
...
def main() -> None:
    ...
    manifest = build_state_shadow(profile, args.pose_csv, rows)
