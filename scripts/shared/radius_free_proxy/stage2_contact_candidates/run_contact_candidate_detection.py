...
from object_contact_candidate_utils import (
    LEFT_HAND_KEY,
    RIGHT_HAND_KEY,
    LEFT_FOOT_KEY,
    RIGHT_FOOT_KEY,
...
def main() -> None:
    ...
    parser.add_argument('--out-subdir', type=str, default='contact_candidates_object_proxy')
    ...
    object_rows = read_object_proxy_track(args.object_proxy_observation_csv or (results_dir / 'object_proxy_observations' / 'object_proxy_observations.csv'))
